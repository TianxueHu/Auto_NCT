setwd('/Users/tianxuehu/Documents/MUSI7100/MusicDatasets/NCT/Data/TAVERN/')
library(stringi)
...
colnames(dataframe)=c("function","harm","melody", "beat_pos","duration", "scale_deg","approaching","key","file")
dataframe
...
write.csv(dataframe,'THEME.csv')
write.table(dataframe, file = "THEME.txt", sep = "\t",
